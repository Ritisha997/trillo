...
import { ibcDenomToDenom } from "./string";
...
export const getAmount = (selectedAmount, coinDecimals) =>
	(selectedAmount * (coinDecimals || 10 ** comdex.coinDecimals))
		.toFixed(0)
		.toString();
...
export const amountConversionWithComma = (amount, decimals, chainDecimals) => {
	...
	return commaSeparator(
		Math.floor(result * Math.pow(10, decimals || comdex.coinDecimals)) /
			Math.pow(10, decimals || comdex.coinDecimals)
	);
};
